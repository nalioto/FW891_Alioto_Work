{ 
  ...
  plot1 = ggplot() +
    ...
    geom_sf(data = lakes_SF,
            ...
            fill = "red") +
    geom_sf_text(data = states_SF,
                   mapping = aes(geometry=geometry, label=postal), #Mapped new column
                   color="violetred") +
    scale_color_gradient(low = "green", high = "yellow") + #changed gradient
...
#Changed the labels of the legends 
  plot3 = plot2 +
